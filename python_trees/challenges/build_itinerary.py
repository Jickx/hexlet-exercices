...
def build_itinerary(tree, start_point, finish_point):
    ...
    start_point_path = generate_path_from_parent_dict(parent_dict, start_point)
    finish_point_path = generate_path_from_parent_dict(parent_dict, finish_point)

    return calculate_start_to_finish(start_point_path, finish_point_path)
